		...
		<div class="flex justify-between items-center">
			...
			<div class="flex w-full justify-end gap-1.5">
				...
				{#if $user?.role === 'admin'}
					...
					>
						<div
							class="cursor-pointer px-2 py-1.5 rounded-xl btn-premium bg-black text-white dark:bg-white dark:text-black transition font-medium text-sm flex items-center"
						>
