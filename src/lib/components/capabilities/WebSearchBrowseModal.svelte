<script lang="ts">
	...
	export let apifyConnector: any = null;
	export let apifyEntry: any = null;
	...
	$: apifyMatches =
		!search.trim() ||
		'apify extraction web prospection'.includes(search.trim().toLowerCase());
