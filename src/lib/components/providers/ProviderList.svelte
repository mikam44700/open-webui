<script lang="ts">
	...
	// Mode intégré (page Hermes de LunarIA) : le parent affiche déjà la ligne « Modèle IA
	// actif » et sa propre barre de puces — on masque les nôtres, on garde le contenu.
...
<div class="w-full max-w-7xl mx-auto px-3 py-3">
	...
	{:else}
		...
		<div class="mb-3 text-sm text-gray-600 dark:text-gray-400" class:hidden={embedded}>
		...
		<div class="flex flex-wrap gap-1.5 mb-3" class:hidden={embedded}>
