...
export const CHANNEL_TAGS: Record<string, string[]> = {
	...
	whatsapp: ['Messages', 'Réponses auto', 'QR code'],
	...
	google_chat: ['Espaces', 'Réponses auto', 'Google Cloud'],
	teams: ['Conversations', 'Réponses auto', 'Bot Teams']
};
...
export const CHANNEL_FR: Record<string, ChannelMeta> = {
	...
	whatsapp: {
		...
		actions: [
			...
			'Répondre automatiquement',
			'Se connecter simplement par QR code'
		]
	},
	whatsapp_cloud: {
		desc: 'Vos agents répondent sur WhatsApp.',
	...
	google_chat: {
		desc: 'Vos agents répondent dans Google Chat.',
		actions: [
			'Recevoir les messages Google Chat',
			'Répondre dans vos espaces',
			'Se connecter via Google Cloud'
		]
	},
	teams: {
		desc: 'Vos agents répondent dans Microsoft Teams.',
		actions: [
			'Recevoir les messages Microsoft Teams',
			'Répondre dans vos conversations',
			'Se connecter via un bot Teams'
		]
	}
};
