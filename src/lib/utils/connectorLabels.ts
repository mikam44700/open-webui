...
// Complètent la description : d'un coup d'œil, ce que fait le connecteur. Keyés par identifiant.
export const CONNECTOR_TAGS: Record<string, string[]> = {
	...
	blender: ['3D', 'Modélisation', 'Rendu'],
	ccxt: ['Crypto', 'Exchanges', 'Trading'],
	cloudflare: ['DNS', 'Workers', 'CDN'],
	coingecko: ['Crypto', 'Prix', 'Marchés'],
	context7: ['Docs à jour', 'Librairies', 'Code'],
	'davinci-resolve': ['Montage vidéo', 'Étalonnage'],
	'docker-hub': ['Images Docker', 'Registre'],
	dune: ['Analytics', 'Blockchain', 'Requêtes'],
	etherscan: ['Ethereum', 'Transactions', 'Contrats'],
	fetch: ['Récupérer des pages', 'HTTP'],
	filesystem: ['Fichiers', 'Dossiers', 'Local'],
	git: ['Dépôts Git', 'Commits', 'Branches'],
	github: ['Dépôts', 'Issues', 'Pull requests'],
	kubernetes: ['Clusters', 'Pods', 'Déploiements'],
	'meigen-ai-design': ['Design', 'Génération'],
	memory: ['Mémoire', 'Notes', 'Rappel'],
	mistral: ['Modèles Mistral', 'IA'],
	neon: ['Postgres', 'Base serverless'],
	playwright: ['Navigateur', 'Automatisation', 'Tests'],
	'polygon-io': ['Marchés', 'Actions', 'Données financières'],
	postgres: ['Base Postgres', 'Requêtes SQL'],
	puppeteer: ['Navigateur', 'Automatisation', 'Chrome'],
	redis: ['Cache', 'Clé-valeur', 'Base'],
	sentry: ['Erreurs', 'Monitoring', 'Alertes'],
	'sequential-thinking': ['Raisonnement', 'Étapes'],
	'solana-agent-kit': ['Solana', 'Blockchain', 'On-chain'],
	sqlite: ['Base SQLite', 'Requêtes SQL'],
	supabase: ['Postgres', 'Auth', 'Stockage'],
	'the-graph': ['Blockchain', 'Indexation', 'Requêtes'],
	thirdweb: ['Web3', 'Contrats', 'Wallets'],
	tradingview: ['Graphiques', 'Marchés', 'Analyse'],
	vercel: ['Déploiements', 'Hébergement', 'Projets'],
	crawl4ai: ['Lecture web', 'Scraping', 'Souverain'],
	hubspot: ['CRM', 'Contacts', 'Deals'],
	linear: ['Tickets', 'Projets', 'Sprints'],
	n8n: ['Automatisation', 'Workflows'],
	'unreal-engine': ['Moteur 3D', 'Jeux', 'Scènes'],
	gmail: ['E-mails', 'Recherche', 'Envoi'],
	'google-calendar': ['Agenda', 'Rendez-vous', 'Disponibilités'],
	'google-drive': ['Fichiers', 'Documents', 'Recherche'],
	notion: ['Pages', 'Bases de données', 'Recherche'],
	slack: ['Canaux', 'Messages', 'Fils'],
	asana: ['Tâches', 'Projets', 'Charge de travail'],
	atlassian: ['Jira', 'Confluence', 'Tickets'],
	airtable: ['Bases', 'Tables', 'Enregistrements'],
	youtube: ['Vidéos', 'Recherche', 'Transcriptions'],
	stripe: ['Paiements', 'Abonnements', 'Remboursements'],
	paypal: ['Factures', 'Transactions', 'Versements'],
	quickbooks: ['Comptabilité', 'Facturation', 'Rapprochement'],
	plaid: ['Données bancaires', 'Soldes', 'Transactions'],
	canva: ['Designs', 'Modèles', 'Édition'],
...
> = {
	apify: {
		...
		actions: [
			...
			'Collecter des contacts et données B2B (annuaires, réseaux…)',
			'Extraire des données de milliers de sites (5000+ robots prêts)',
