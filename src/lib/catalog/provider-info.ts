...
export const PROVIDER_INFO: Record<string, ProviderInfo> = {
	...
	'azure-foundry': {
		...
		about: ['Modèles hébergés sur le cloud Azure', 'Pour les entreprises déjà chez Microsoft']
	},
	groq: {
		desc: 'Groq — inférence ultra-rapide.',
		keyUrl: 'https://console.groq.com/keys',
		usageUrl: 'https://console.groq.com/dashboard/usage',
		about: ['Réponses très rapides sur modèles open source (Llama…)', 'Bon marché']
	},
	cerebras: {
		desc: 'Cerebras — la vitesse record.',
		keyUrl: 'https://cloud.cerebras.ai/',
		usageUrl: 'https://cloud.cerebras.ai/',
		about: ['Réponses quasi instantanées (puce dédiée à l’IA)', 'Idéal quand la rapidité prime']
	},
	together: {
		...
		about: ['Llama, DeepSeek, Qwen et bien d’autres au même endroit', 'Bon rapport qualité/prix']
	},
	fireworks: {
		desc: 'Fireworks AI — modèles ouverts rapides et pas chers.',
		keyUrl: 'https://fireworks.ai/account/api-keys',
		usageUrl:
			'https://app.fireworks.ai/account/usage?type=serverless&category=usage&start=now-14d&end=now&interval=30m&usageGroupBy=model_name',
		about: ['Llama, DeepSeek et autres modèles ouverts', 'Bon équilibre entre vitesse et prix']
	},
	deepinfra: {
		desc: 'DeepInfra — plus de 100 modèles ouverts via une API simple.',
		keyUrl: 'https://deepinfra.com/dash/api_keys',
		usageUrl: 'https://deepinfra.com/dash/usage',
		about: [
			'Accédez aux modèles ouverts récents sans gérer de serveur',
			'Paiement à l’usage, avec une API compatible OpenAI'
		]
	},
	upstage: {
		desc: 'Upstage — modèles Solar et intelligence documentaire.',
		keyUrl: 'https://console.upstage.ai/api-keys',
		usageUrl: 'https://console.upstage.ai',
		about: [
			'Modèles Solar pour le raisonnement, la rédaction et le code',
			'Spécialiste de l’analyse et de l’extraction de documents'
		]
	},
	...
	xiaomi: {
		...
		about: ['Modèles légers, orientés raisonnement', 'Alternative open source économique']
	},
	'tencent-tokenhub': {
	...
	'minimax-cn': {
		...
		about: ['Les mêmes modèles MiniMax, serveurs en Chine', 'Multimodal (texte + audio)']
	},
	stepfun: {
	...
	'xai-oauth': {
		...
		about: ['Réutilise votre abonnement X, sans clé à saisir', 'Pratique si vous êtes déjà abonné'],
	...
	'ollama-local': {
		...
		about: ['Tourne chez vous, aucune donnée ne sort', 'Gratuit et totalement confidentiel']
	},
