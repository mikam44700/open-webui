<script lang="ts">
	...
	onMount(async () => {
		...
		// LunarIA : le modal "Quoi de neuf" ne doit jamais apparaitre chez un client.
		// Declenchement automatique supprime (demande Michael, 2026-07-18).
...
<!-- LunarIA : ChangelogModal supprime - le "Quoi de neuf" n'existe plus -->
